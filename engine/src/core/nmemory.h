...
NAPI void* nallocate(u64 size, memory_tag tag);
NAPI void nfree(void* block, u64 size, memory_tag tag);
NAPI void* nzero_memory(void* block, u64 size);
NAPI void* ncopy_memory(void* dest, const void* source, u64 size);
