...
NAPI b8 input_was_key_pressed(keys key);
NAPI b8 input_was_key_released(keys key);

void input_process_key(keys key, b8 pressed);

NAPI b8 input_is_button_down(buttons button);
NAPI b8 input_is_button_up(buttons button);
NAPI b8 input_was_button_pressed(buttons button);
NAPI b8 input_was_button_released(buttons button);
